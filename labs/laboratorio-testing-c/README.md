...
> R: Inicializa el carrito. Es importante llamarla para que el carrito esté vacío
...
> R: línea 24. Dice que se tiene que multiplicar por la cantidad
...
> R: Si, las líneas de carrito_descuento.
...
> R: un test unitario prueba una unidad del código, el test de integración 
...
> R: es peligroso porque en C manejamos la memoria directamente.
...
> R: los tests son más eficientes que mirar el código.
...
> R: por la forma en la que el test estaba escrito.
